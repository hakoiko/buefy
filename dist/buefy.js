...
/* harmony default export */ __webpack_exports__["default"] = ({
    ...
    methods: {
        ...
        */
         ...
         * Resize column width.
         */
        onColumnWidthResize: function onColumnWidthResize(e, column) {
         ...
         */
        endColumnWidthResize: function endColumnWidthResize(e) {
...
module.exports={render:function (){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;
  return _c('div', {
    ...
    })], 2), _vm._v(" "), (_vm.resizable && index < _vm.newColumns.length - 1) ? _c('div', {
      staticClass: "th-resize-handle",
      attrs: {
        "draggable": "draggable"
      },
      on: {
        "dragstart": function($event) {
          _vm.startColumnWidthResize($event)
        },
        "drag": function($event) {
          $event.stopPropagation();
          $event.preventDefault();
          _vm.onColumnWidthResize($event, column)
        },
        "dragend": function($event) {
          _vm.endColumnWidthResize($event)
        }
      }
    }, [_c('b-icon', {
      attrs: {
